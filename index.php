                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <a class="navbar-brand d-none d-lg-block" href="index.html">
                                RS Lopi
                                <strong class="d-block">Poliklinik Spesialis</strong>
                            </a>
                            ...
                            <div class="heroText d-flex flex-column justify-content-center">
                                ...
                                <h1 class="mt-auto mb-2">
                                    ...
                                    <div class="animated-info">
                                        <span class="animated-item">Sehat</span>
                                        <span class="animated-item">Teratur</span>
                                        <span class="animated-item">Konsisten</span>
                                    </div>
                                </h1>
                                ...
                                <div class="heroLinks d-flex flex-wrap align-items-center">
                                    <a class="custom-link me-4" href="login.php" data-hover="KLIK UNTUK LOGIN">Login Sebagai Dokter</a>

									<a class="custom-link me-4" href="login-pasien.php" data-hover="KLIK UNTUK LOGIN">Login Sebagai Pasien</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 me-auto col-12">
                        <h5 class="mb-lg-4 mb-3">Bimbingan Karir</h5>
